...
var Title = function (_Phaser$Sprite) {
	_inherits(Title, _Phaser$Sprite);

	function Title(game, x, y) {
		_classCallCheck(this, Title);

		var _this = _possibleConstructorReturn(this, (Title.__proto__ || Object.getPrototypeOf(Title)).call(this, game, x, y, 'title'));
...
var Paddle = function (_Phaser$Sprite) {
	...
	_createClass(Paddle, [{
		...
		value: function update() {
			...
			if (this.game.input.keyboard.isDown(_phaser2.default.Keyboard.RIGHT)) {
				this.x += 6;
			}
		}
	}]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 43), __webpack_require__(/*! ./../webpack/buildin/module.js */ 347)(module)))
...
var Paddle1 = function (_Phaser$Sprite) {
	_inherits(Paddle1, _Phaser$Sprite);

	function Paddle1(game, x, y) {
		_classCallCheck(this, Paddle1);

		var _this = _possibleConstructorReturn(this, (Paddle1.__proto__ || Object.getPrototypeOf(Paddle1)).call(this, game, x, y, 'paddle'));
	...
	_createClass(Paddle1, [{
		key: 'update',
		value: function update() {

			if (this.game.input.keyboard.isDown(_phaser2.default.Keyboard.A)) {
				this.x -= 6;
			}
			if (this.game.input.keyboard.isDown(_phaser2.default.Keyboard.D)) {
				this.x += 6;
			}
		}
	}]);
...
exports.default = Paddle1;

/***/ }),
/* 137 */
/*!*******************************!*\
  !*** ./src/prefabs/Brick1.js ***!
  \*******************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Brick1 = function (_Phaser$Sprite) {
	_inherits(Brick1, _Phaser$Sprite);

	function Brick1(game, x, y) {
		_classCallCheck(this, Brick1);

		var _this = _possibleConstructorReturn(this, (Brick1.__proto__ || Object.getPrototypeOf(Brick1)).call(this, game, x, y, 'brick1'));
...
module.exports = __webpack_require__(/*! /home/sumanth/breakout/phaser-es6-webpack/src/main.js */341);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(/*! ./_hide */ 13)(proto, TO_PRIMITIVE, __webpack_require__(/*! ./_date-to-primitive */ 223));
...
var userAgent = __webpack_require__(/*! ./_user-agent */ 97);
...
var _Boot = __webpack_require__(/*! ./states/Boot */ 346);

var _Boot2 = _interopRequireDefault(_Boot);

var _Splash = __webpack_require__(/*! ./states/Splash */ 348);
...
var _End = __webpack_require__(/*! ./states/End */ 351);

var _End2 = _interopRequireDefault(_End);

var _End3 = __webpack_require__(/*! ./states/End1 */ 352);

var _End4 = _interopRequireDefault(_End3);

var _Player = __webpack_require__(/*! ./states/Player */ 353);

var _Player2 = _interopRequireDefault(_Player);

var _Simultaneous = __webpack_require__(/*! ./states/Simultaneous */ 354);

var _Simultaneous2 = _interopRequireDefault(_Simultaneous);

var _Login = __webpack_require__(/*! ./states/Login */ 355);

var _Login2 = _interopRequireDefault(_Login);

var _Second = __webpack_require__(/*! ./states/Second */ 356);

var _Second2 = _interopRequireDefault(_Second);

var _secondSimul = __webpack_require__(/*! ./states/secondSimul */ 357);

var _secondSimul2 = _interopRequireDefault(_secondSimul);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    _this.state.add('Player', _Player2.default, false);
    _this.state.add('Simultaneous', _Simultaneous2.default, false);
    _this.state.add('Boot', _Boot2.default, false);
    _this.state.add('Splash', _Splash2.default, false);
    _this.state.add('Game', _Game2.default, false);
    _this.state.add('End', _End2.default, false);
    _this.state.add('End1', _End4.default, false);
    _this.state.add('singlesecond', _Second2.default, false);
    _this.state.add('secondSimul', _secondSimul2.default, false);

    if (!window.cordova) {

      _this.state.start('Player');
    }
    return _this;
  }
...
__webpack_require__(/*! dotenv */ 358).config();
...
var _webfontloader = __webpack_require__(/*! webfontloader */ 67);
...
var _index = __webpack_require__(/*! ./globals/index */ 135);

var _index2 = _interopRequireDefault(_index);

var _lodash = __webpack_require__(/*! lodash */ 98);
...
var _Brick = __webpack_require__(/*! ../prefabs/Brick */ 68);

var _Brick2 = _interopRequireDefault(_Brick);

var _Paddle = __webpack_require__(/*! ../prefabs/Paddle */ 69);

var _Paddle2 = _interopRequireDefault(_Paddle);

var _Ball = __webpack_require__(/*! ../prefabs/Ball */ 70);

var _Ball2 = _interopRequireDefault(_Ball);

var _Title = __webpack_require__(/*! ../prefabs/Title */ 52);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'setGameOverSound',
    value: function setGameOverSound() {

      over = this.game.add.audio('gamesound');
    }
  }, {
    key: 'setHitPaddleSound',
    value: function setHitPaddleSound() {
    ...
    value: function setupTitle() {
      this.title = new _Title2.default(this.game, this.game.world.centerX - 200, this.game.world.height - 920);
    ...
    value: function ballLost() {
      ...
      this.camera.shake(0.4, 100, true, _phaser2.default.Camera.SHAKE_BOTH, true);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'setUpText',
    value: function setUpText() {
      var text = this.add.text(this.game.width * 0.5, this.game.height * 0.3, 'G A M E - O V E R', {
    ...
    value: function setUpScore() {
      var text = this.add.text(this.game.width * 0.5, this.game.height * 0.4, 'Score: ' + this.game.global.score, {
    ...
    key: 'setUpHiScore',
    value: function setUpHiScore() {
      var score = this.game.global.score;
      var text = this.add.text(this.game.width * 0.5, this.game.height * 0.5, "Hi Score: 578", {
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'setUpHiScore',
    value: function setUpHiScore() {
      var text = this.add.text(this.game.width * 0.5, this.game.height * 0.5, "Hi Score:", {
...
var _Paddle3 = __webpack_require__(/*! ../prefabs/Paddle1 */ 136);

var _Paddle4 = _interopRequireDefault(_Paddle3);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'setUpPaddle',
    value: function setUpPaddle() {
      this.paddle = new _Paddle2.default(this.game, this.game.world.centerX * 1.5, this.game.world.height - 200);
      this.game.add.existing(this.paddle);
    }
  }, {
    key: 'setUpPaddle1',
    value: function setUpPaddle1() {
      this.paddle1 = new _Paddle4.default(this.game, this.game.world.centerX * 0.5, this.game.world.height - 300);
    ...
    value: function generateBricks(bricksGroup) {
      ...
      for (var y = 0; y < 1; y++) {
        ...
        for (var _x = 20; _x < 0; _x++) {

          brick = new _Brick2.default(this.game, _x * xOffset, y * yOffset);
          bricksGroup.add(brick);
        }
      }
      var bricksGroupWidth = (xOffset * columns - (xOffset - brick.width)) / 2;
    ...
    key: 'generateBricks1',
    value: function generateBricks1(bricksGroup) {
      ...
      bricksGroup.position.setTo(this.game.world.centerX - bricksGroupWidth, this.game.world.centerY - 300);
    }
  }, {
    key: 'endGame',
    value: function endGame() {
...
var _Brick3 = __webpack_require__(/*! ../prefabs/Brick1 */ 137);

var _Brick4 = _interopRequireDefault(_Brick3);
...
var _class = function (_Phaser$State) {
	...
	_createClass(_class, [{
		...
		value: function create() {
			...
			bullets.physicsBodyType = _phaser2.default.Physics.ARCADE;
		...
		key: 'setUpSingleaudio',
		value: function setUpSingleaudio() {
		...
		key: 'generateBtick2',
		value: function generateBtick2(bricksGroup1) {
			var rows = 1;
			var columns = 1;
			var xOffset = 55;
			var yOffset = 45;
			...
			for (var y = 0; y < 1; y++) {
				for (var x = 0; x < 1; x++) {
					brick1 = new _Brick4.default(this.game, x * xOffset, y * yOffset);
					bricksGroup1.add(brick1);
				}
			}
			var bricksGroup1Width = (xOffset * columns - (xOffset - brick1.width)) / 2;
			bricksGroup1.position.setTo(this.game.world.centerX - bricksGroup1Width, this.game.world.centerY - 300);
		}
	}, {
		key: 'generateBricks',
		value: function generateBricks(bricksGroup) {
		...
		key: 'resetBullet',
		value: function resetBullet(bullet) {
		...
		key: 'ballHitRed',
		value: function ballHitRed(ball, brick1) {
			brick1.kill();
			current = '' + this.game.global.lives;
		}
	}, {
		key: 'bulletHitBrick',
		value: function bulletHitBrick(bullet, brick) {
			bullet.kill();
			brick.kill();
			if (brick.position.y == 135) {
		...
		value: function update() {
			...
			this.game.physics.arcade.collide(this.ball, this.bricks, this.ballHitBrick, null, this);
			this.game.physics.arcade.collide(this.ball, this.paddle, this.ballHitPaddle, null, this);
			game.physics.arcade.overlap(bullets, this.bricks, this.bulletHitBrick, null, this);
			game.physics.arcade.collide(this.ball, this.brick1, this.ballHitRed, null, this);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      fires.physicsBodyType = _phaser2.default.Physics.ARCADE;
    ...
    key: 'generateBrick2',
    value: function generateBrick2(bricksGroup1) {
      var rows = 1;
      var columns = 1;
      var xOffset = 55;
      var yOffset = 45;
    ...
    key: 'setUpFlameSound',
    value: function setUpFlameSound() {
      flame = this.game.add.audio('flame');
    }
  }, {
    key: 'setUpBackgrund',
    value: function setUpBackgrund() {
    ...
    key: 'fireHitPaddle',
    value: function fireHitPaddle(fires, paddle) {
    ...
    value: function update() {
      ...
      this.game.physics.arcade.collide(this.ball, this.paddle, this.ballHitPaddle, null, this);
      this.game.physics.arcade.collide(this.ball, this.paddle1, this.ballHitPaddle1, null, this);

      this.game.physics.arcade.collide(this.ball, this.bricks, this.ballHitBrick, null, this);
      this.game.physics.arcade.collide(fires, this.paddle, this.fireHitPaddle, null, this);
      this.game.physics.arcade.collide(fires, this.paddle1, this.fireHitPaddle, null, this);
      game.physics.arcade.overlap(bullets, this.bricks, this.bulletHitBrick, null, this);
      game.physics.arcade.collide(this.ball, this.brick1, this.ballHitRed, null, this);
    ...
    key: 'ballHitPaddle1',
    value: function ballHitPaddle1(ball, paddle1) {
      var diff = 0;
      flag = 1;
      if (ball.x < paddle1.x) {
...
var fs = __webpack_require__(/*! fs */ 359)
...
function config (options) {
  ...
  try {
    ...
    Object.keys(parsedObj).forEach(function (key) {
      Object({"NODE_ENV":"DEVELOPMENT","DB_HOST":"localhost","DB_USER":"root","DB_PASSWORD":"mypass","DB_NAME":"breakout"})[key] = Object({"NODE_ENV":"DEVELOPMENT","DB_HOST":"localhost","DB_USER":"root","DB_PASSWORD":"mypass","DB_NAME":"breakout"})[key] || parsedObj[key]
    })
